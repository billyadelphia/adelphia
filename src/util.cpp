...
const char * const BITCOIN_CONF_FILENAME = "adelphia.conf";
const char * const BITCOIN_PID_FILENAME = "adelphiad.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Adelphia";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Adelphia";
#else
    // Unix
    return pathRet / ".adelphia";
#endif
#endif
}
