...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s adelphia-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  adelphia-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded adelphia transaction") + "\n" +
              "  adelphia-tx [options] -create [commands]   " + _("Create hex-encoded adelphia transaction") + "\n" +
              "\n";
