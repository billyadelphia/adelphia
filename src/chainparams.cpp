...
public:
    CMainParams() {
        ...
        // vSeeds.emplace_back("seed-a.adelphia.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.adelphiatools.com");
        // vSeeds.emplace_back("dnsseed.adelphiapool.org");
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("testnet-seed.adelphiatools.com");
        // vSeeds.emplace_back("seed-b.adelphia.loshan.co.uk");
