...
* adelphia.conf: contains configuration settings for adelphiad or adelphia-qt
* adelphiad.pid: stores the process id of adelphiad while running
...
* debug.log: contains debug information and general logging generated by adelphiad or adelphia-qt
