Adelphia Core version *0.15.1* is now available from:

  <https://download.adelphia.org/adelphia-0.15.1/>
...
A number of changes to the way Adelphia Core deals with peer connections and invalid blocks
